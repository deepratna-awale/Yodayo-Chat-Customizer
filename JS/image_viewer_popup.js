...
function handleClickOutside(event) {
    // Don't close if clicking on settings modal (check dynamically created modal)
    /** @type {HTMLElement|null} */
...
function initializeSettingsModal(imageViewer) {
    ...
    // Open settings modal - create it dynamically when needed
...
/**
 * Create and show the settings modal dynamically
 * @returns {void}
 */
function createAndShowSettingsModal() {
    ...
    initializeModalEventHandlers(settingsModal);
}

/**
 * Initialize event handlers for the settings modal
 * @param {HTMLElement} settingsModal
 * @returns {void}
 */
function initializeModalEventHandlers(settingsModal) {
    /** @type {HTMLElement|null} */
    const settingsModalClose = settingsModal.querySelector('#settings-modal-close');
    /** @type {HTMLElement|null} */
    const exportJsonBtn = settingsModal.querySelector('#export-json-btn');
    /** @type {HTMLElement|null} */
    const exportPngBtn = settingsModal.querySelector('#export-png-btn');
    /** @type {HTMLElement|null} */
    const importFileInput = settingsModal.querySelector('#import-file-input');
    /** @type {HTMLElement|null} */
    const importUrlInput = settingsModal.querySelector('#import-url-input');
    /** @type {HTMLElement|null} */
    const importUrlBtn = settingsModal.querySelector('#import-url-btn');
    /** @type {HTMLElement|null} */
    const clearExistingCheckbox = settingsModal.querySelector('#clear-existing-data');

    // Close settings modal
    const closeModal = () => {
        settingsModal.remove(); // Remove the modal from DOM instead of hiding
        clearImportStatus();
    };
